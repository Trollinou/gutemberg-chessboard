...
```sh[HTTPS]
git clone https://github.com/trollinou/gutemberg-chessboard.git
```

```sh[SSH]
git clone git@github.com:trollinou/gutemberg-chessboard.git
```

```sh[GitHub CLI]
gh repo clone trollinou/gutemberg-chessboard
```
